...
func init() {
	RegisterNode("group_wait", func(name string, attrs map[string]string) (Node, error) {
	...
	RegisterNode("group_labels", func(name string, attrs map[string]string) (Node, error) {
