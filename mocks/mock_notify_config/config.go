...
// Source: ./internal/services/notify/notify_config/config.go

// Package mock_notify_config is a generated GoMock package.
package mock_notify_config
...
import (
	...
	notify_config "github.com/sinkingpoint/kiora/internal/services/notify/notify_config"
...
func (m *MockConfig) GetNotifiersForAlert(ctx context.Context, alert *model.Alert) []notify_config.Notifier {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNotifiersForAlert", ctx, alert)
	ret0, _ := ret[0].([]notify_config.Notifier)
	return ret0
}
