...
// MockAlertProcessor is a mock of AlertProcessor interface.
type MockAlertProcessor struct {
	ctrl     *gomock.Controller
	recorder *MockAlertProcessorMockRecorder
}

// MockAlertProcessorMockRecorder is the mock recorder for MockAlertProcessor.
type MockAlertProcessorMockRecorder struct {
	mock *MockAlertProcessor
}

// NewMockAlertProcessor creates a new mock instance.
func NewMockAlertProcessor(ctrl *gomock.Controller) *MockAlertProcessor {
	mock := &MockAlertProcessor{ctrl: ctrl}
	mock.recorder = &MockAlertProcessorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAlertProcessor) EXPECT() *MockAlertProcessorMockRecorder {
	return m.recorder
}

// ProcessAlerts mocks base method.
func (m *MockAlertProcessor) ProcessAlerts(ctx context.Context, alerts ...model.Alert) error {
	m.ctrl.T.Helper()
...
func (mr *MockAlertProcessorMockRecorder) ProcessAlerts(ctx interface{}, alerts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx}, alerts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessAlerts", reflect.TypeOf((*MockAlertProcessor)(nil).ProcessAlerts), varargs...)
}

// MockSilenceProcessor is a mock of SilenceProcessor interface.
type MockSilenceProcessor struct {
	ctrl     *gomock.Controller
	recorder *MockSilenceProcessorMockRecorder
}

// MockSilenceProcessorMockRecorder is the mock recorder for MockSilenceProcessor.
type MockSilenceProcessorMockRecorder struct {
	mock *MockSilenceProcessor
}

// NewMockSilenceProcessor creates a new mock instance.
func NewMockSilenceProcessor(ctrl *gomock.Controller) *MockSilenceProcessor {
	mock := &MockSilenceProcessor{ctrl: ctrl}
	mock.recorder = &MockSilenceProcessorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSilenceProcessor) EXPECT() *MockSilenceProcessorMockRecorder {
	return m.recorder
}

// ProcessSilences mocks base method.
func (m *MockSilenceProcessor) ProcessSilences(ctx context.Context, silences ...model.Silence) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx}
...
func (mr *MockSilenceProcessorMockRecorder) ProcessSilences(ctx interface{}, silences ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx}, silences...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessSilences", reflect.TypeOf((*MockSilenceProcessor)(nil).ProcessSilences), varargs...)
}
